...
weatherD <- read.csv('https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/retrievebulkdataset?&key=NEVVZ6BDLFDNDBMTUR4Y3RA3S&taskId=89a042b0c289031dae9ea1974a1f9211&zip=false')
